...
export default function India(): React.JSX.Element {
  return (
    <section className="chapter chapter-india" id="india" data-num="06">
      ...
      <p style={{ margin: "2.5rem 0", paddingLeft: "1.25rem", borderLeft: "6px solid #e0862a", fontFamily: '"Arial Narrow", "Helvetica Neue", system-ui, sans-serif', fontWeight: 900, textTransform: "uppercase", letterSpacing: "-0.015em", lineHeight: 1, fontSize: "clamp(1.8rem, 5vw, 3.25rem)", color: "#f2ede4" }}>“The price of anything is the amount of life you exchange for it” — Henry David Thoreau</p>
